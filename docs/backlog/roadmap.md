...
- Slash commands, template flows, folder navigation, export, tags, and deploy discipline are now present as first-pass foundations.
...
- Current next-layer work is deeper refinement rather than missing foundations: richer table cell UX, stronger template editing ergonomics, semantic search, and fuller local-first sync.
