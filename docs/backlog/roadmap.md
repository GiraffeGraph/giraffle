...
- Current next-layer work is deeper refinement rather than missing foundations: richer table cell UX, stronger template editing ergonomics, more advanced graph filtering, semantic search, and fuller local-first sync.
